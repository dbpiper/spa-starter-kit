...
/* disable linting for this case because we are actually using the
   dynamic require for a specific reason: that is, we don't want to
   hard-code in the path here. This was done by create-react-app
